...
const CACHE_NAME = 'spendwise-v2.1.0';
...
// No external CDN dependencies — app is 100% self-contained (system fonts,
// inline Chart Engine v3). Kept as empty array for forward compatibility.
const CDN_URLS = [];
